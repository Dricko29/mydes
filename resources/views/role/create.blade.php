...
@section('title', 'Form '.__('Add').' Role')
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form" action="{{ route('site.roles.store') }}" method="post">
            @csrf
          <div class="col-12">
                            ...
                            <td>
                                <div class="d-flex">
                                    @foreach (\Spatie\Permission\Models\Permission::where('module', $module['module'])->get() as $perm)
                                        ...
                                        <input class="form-check-input" type="checkbox" name="permission[]" id="{{ $perm->id }}" value="{{ $perm->id }}" />
