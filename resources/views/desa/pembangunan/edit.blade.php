    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" action="{{ route('site.pembangunan.update', $pembangunan->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="nama"
                                    value="{{ old('nama', $pembangunan->nama) }}"
                                    />
                                    @error('nama')
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="volume"
                                    value="{{ old('volume', $pembangunan->volume) }}"
                                    />
                                    @error('volume')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <select class="form-select select2" id="lama" name="lama">
                                    <option value="Hari"{{ $waktu[1] == "Hari" ? 'selected' : ''}}>Hari</option>
                                    <option value="Minggu"{{ $waktu[1] == "Minggu" ? 'selected' : '' }}>Minggu</option>
                                    <option value="Bulan"{{ $waktu[1] == "Bulan" ? 'selected' : '' }}>Bulan</option>
                                    <option value="Tahun"{{ $waktu[1]  == "Tahun" ? 'selected' : ''}}>Tahun</option>
                                </select>
                                </div>
                            </div>
                            <div class="col-12">
                                ...
                                <select class="form-select select2" id="sumber_dana_id" name="sumber_dana_id" required>
                                    ...
                                    @foreach ($sumber as $item)   
                                        <option value="{{ $item->id }}" {{ old('sumber_dana_id', $pembangunan->sumber_dana_id) == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="tahun_anggaran"
                                    value="{{ old('tahun_anggaran', $pembangunan->tahun_anggaran) }}"
                                    />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="sb_pemerintah"
                                    value="{{ old('sb_pemerintah', $pembangunan->sb_pemerintah) }}"
                                    />
                                    @error('sb_pemerintah')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="sb_provinsi"
                                    value="{{ old('sb_provinsi', $pembangunan->sb_provinsi) }}"
                                    />
                                    @error('sb_provinsi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="sb_kab_kot"
                                    value="{{ old('sb_kab_kot', $pembangunan->sb_kab_kot) }}"
                                    />
                                    @error('sb_kab_kot')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="sb_swadaya"
                                    value="{{ old('sb_swadaya', $pembangunan->sb_swadaya) }}"
                                    />
                                    @error('sb_swadaya')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <select class="form-select select2" id="sifat" name="sifat" required>
                                    <option value=""></option>
                                    <option value="1" {{ old('sifat',$pembangunan->sifat) == 1 ? 'selected' : ''}}>Baru</option>
                                    <option value="2" {{ old('sifat',$pembangunan->sifat) == 2 ? 'selected' : ''}}>Lanjut</option>
                                </select>
                                </div>
                            </div>
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="pelaksana"
                                    value="{{ old('pelaksana',$pembangunan->pelaksana) }}"
                                    />
                                    @error('pelaksana')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control @error('manfaat')
                                        is-invalid
                                    @enderror" id="manfaat" name="manfaat" rows="3">{{ old('manfaat',$pembangunan->manfaat) }}</textarea>
                                    @error('manfaat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control @error('keterangan')
                                        is-invalid
                                    @enderror" id="keterangan" name="keterangan" rows="3">{{ old('keterangan',$pembangunan->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
