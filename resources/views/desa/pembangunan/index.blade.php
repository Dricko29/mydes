    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">List Pembangunan</h4>
          <a href="{{ route('site.pembangunan.create') }}" class="btn btn-primary">@lang('Add')</a>
        </div>
  ...
  <script>
    ...
    $(function () {
        ...
        if (dt_ajax_table.length) {
            ...
            processing: true,
            ajax: '{{ route('site.pembangunan.index') }}', // JSON file to add data
            columns: [
            ...
            columnDefs: [
              {
                ...
                render: function (data, type, full, meta) {
                  var id = full['id'];
                  return (
                    '<a href="/site/pembangunan/' + full['id'] +'" class="item-edit me-1" title="detail">' +
                    feather.icons['eye'].toSvg({ class: 'font-small-4' }) +
                    '</a>'+
                    '<a href="/site/dokumentasi/pembangunan/' + full['id'] +'" class="item-edit me-1" title="dokumentasi">' +
                    feather.icons['image'].toSvg({ class: 'font-small-4' }) +
                    '</a>'+
                    '<a href="/site/pembangunan/' + full['id'] +'/edit" class="item-edit me-1" title="edit">' +
                ...
                buttons: [
                  {
                    ...
                    title: "Laporan Data Pembangunan",
    ...
    function hapus(e){
      var url = '{{ route("site.pembangunan.destroy", ":id") }}';
