  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header border-bottom">
        <h4 class="card-title">Data Penduduk {{ $route == 'lahir' ? 'Lahir' : 'Masuk' }}</h4>
        <a href="{{ route('site.penduduk.index') }}" class="btn btn-primary">@lang('Back')</a>
      </div>
      <div class="card-body py-2 my-25">
        <!-- form -->
        <form class="validate-form mt-2 pt-50" action="{{ $route == 'lahir' ? route('site.penduduk.lahir.store') : route('site.penduduk.masuk.store') }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <!-- header section -->
            ...
            <div class="col-12 col-sm-4 mb-1">
                ...
                <input type="text" id="fp-time" class="form-control flatpickr-time text-start" name="waktu_kelahiran" placeholder="HH:MM" />
            </div>
            <div class="col-12 col-sm-4 mb-1">
