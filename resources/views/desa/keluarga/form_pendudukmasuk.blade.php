  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header border-bottom">
        <h4 class="card-title">Data Keluarga Penduduk Masuk</h4>
        <a href="{{ route('site.keluarga.index') }}" class="btn btn-primary">@lang('Back')</a>
      </div>
      <div class="card-body py-2 my-25">
        <!-- form -->
        <form class="validate-form mt-2 pt-50" action="{{ route('site.keluarga.pendudukMasuk.store') }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <!-- header section -->
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <input
                ...
                value="{{ old('no_keluarga_sebelumnya') }}"
              />
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <select class="form-select select2" id="hubungan" name="attr_hubungan_id">
                ...
                @foreach ($hubungan as $item)
                    <option value="{{ $item->id }}" {{ old('attr_hubungan_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="col-12 col-sm-12 mb-1">
              ...
              <select class="form-select select2" id="status" name="attr_status_id">
                ...
                @foreach ($status as $item)
                    <option value="{{ $item->id }}" {{ old('attr_status_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="col-12 col-sm-4 mb-1">
              ...
              <select class="form-select select2" id="jenis_kelahiran" name="jenis_kelahiran">
                ...
                <option value="kembar 5" {{ old('jenis_kelahiran') == 'kembar 5' ? 'selected' : ''  }}>Kembar 5</option>
              </select>
            </div>

            <div class="col-12 col-sm-4 mb-1">
                <label class="form-label" for="fp-time">Waktu Kelahiran</label>
                <input type="text" id="fp-time" class="form-control flatpickr-time text-start" value="{{ old('waktu_kelahiran') }}" name="waktu_kelahiran" placeholder="HH:MM" />
            </div>
            <div class="col-12 col-sm-4 mb-1">
            ...
            <div class="col-12 col-sm-4 mb-1">
              ...
              <select class="form-select select2" id="pendidikan" name="attr_pendidikan_id">
                ...
                @foreach ($pendidikan as $item)
                    <option value="{{ $item->id }}" {{ old('attr_pendidikan_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="col-12 col-sm-4 mb-1">
              ...
              <select class="form-select select2" id="pekerjaan" name="attr_pekerjaan_id">
                ...
                @foreach ($pekerjaan as $item)
                    <option value="{{ $item->id }}" {{ old('attr_pekerjaan_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <select class="form-select select2" id="suku" name="attr_suku_id">
                ...
                @foreach ($suku as $item)
                    <option value="{{ $item->id }}" {{ old('attr_suku_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <select class="form-select select2" id="warganegara" name="attr_warganegara_id">
                ...
                @foreach ($warganegara as $item)
                    <option value="{{ $item->id }}" {{ old('attr_warganegara_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="col-12 col-sm-4 mb-1">
              ...
              <select class="form-select select2" id="dusun" name="dusun_id">
                ...
                @foreach ($dusun as $item)
                    <option value="{{ $item->id }}" {{ old('dusun_id') == $item->id ? 'selected' : '' }}>{{ $item->nama_dusun }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="col-12 col-sm-12 mb-1">
              ...
              <select class="form-select select2" id="attr_status_kawin" name="attr_status_kawin_id">
                ...
                @foreach ($statusKawin as $item)
                    <option value="{{ $item->id }}" {{ old('attr_status_kawin_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <select class="form-select select2" id="attr_golongan_darah" name="attr_golongan_darah_id">
                ...
                @foreach ($golonganDarah as $item)
                    <option value="{{ $item->id }}" {{ old('attr_golongan_darah_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="col-12 col-sm-12 mb-1">
              ...
              <select class="form-select select2" id="attr_bahasa" name="attr_bahasa_id">
                ...
                @foreach ($bahasa as $item)
                    <option value="{{ $item->id }}" {{ old('attr_bahasa_id') == $item->id ? 'selected' : '' }}>{{ $item->deskripsi }}</option>
                @endforeach
              </select>
            </div>
