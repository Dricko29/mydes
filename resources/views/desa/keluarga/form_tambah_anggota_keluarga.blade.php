  ...
  <div class="col-12">
    ...
    <div class="card">
      ...
      <div class="card-body py-2">
        <!-- form -->
        <form class="validate-form" action="{{ route('site.keluarga.anggota.update', $keluarga->id) }}" method="post" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="jabatan">Kepala Keluarga</label>
              <select class="form-select select2" id="jabatan" name="penduduk_id">
            ...
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="no_keluarga">Nomor KK</label>
              <input
                type="text"
