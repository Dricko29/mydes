...
@section('title', 'Tambah Inventaris Konstruksi Berjalan')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" action="{{ route('site.inventarisKonstruksiBerjalan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-select select2" id="fisik_bangunan_id" name="fisik_bangunan_id" required>
                                    ...
                                    @foreach ($fisikBangunan as $item)   
                                        <option value="{{ $item->id }}" {{ old('fisik_bangunan_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <select class="form-select select2" id="beton" name="beton" required>
                                    <option value="1" {{ old('beton') == 1 ? 'selected' : '' }} selected>Ya</option>
                                    <option value="0" {{ old('beton') == 0 ? 'selected' : '' }}>Tidak</option>
                                </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                ...
                                <input type="text" class="form-control @error('tanggal_mulai')
                                    is-invalid
                                @enderror picker" name="tanggal_mulai" id="tanggal_mulai" value="{{ old('tanggal_mulai') }}" autocomplete="off"/>
                                @error('tanggal_mulai')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <input type="text" class="form-control @error('tanggal_dokumen_bangunan')
                                    is-invalid
                                @enderror picker" name="tanggal_dokumen_bangunan" id="tanggal_dokumen_bangunan" value="{{ old('tanggal_dokumen_bangunan') }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-select select2" id="status_tanah_id" name="status_tanah_id" required>
                                    ...
                                    @foreach ($statusTanah as $item)   
                                        <option value="{{ $item->id }}" {{ old('status_tanah_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control @error('lokasi')
                                        is-invalid
                                    @enderror" id="lokasi" name="lokasi" rows="3">{{ old('lokasi') }}</textarea>
                                    @error('lokasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
