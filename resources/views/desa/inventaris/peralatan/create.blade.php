...
@section('title', 'Tambah Inventaris Peralatan Dan Mesin')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" action="{{ route('site.inventarisPeralatan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-select select2" id="kategori_peralatan_id" name="kategori_peralatan_id" required>
                                    ...
                                    @foreach ($kategoriPermes as $item)   
                                        <option value="{{ $item->id }}" {{ old('kategori_peralatan_id') == $item->id ? 'selected' : '' }}>{{ $item->kode }} - {{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
