...
@section('title', 'Tambah Inventaris Bangunan')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" action="{{ route('site.inventarisBangunan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-select select2" id="kategori_bangunan_id" name="kategori_bangunan_id" required>
                                    ...
                                    @foreach ($kategoriBangunan as $item)   
                                        <option value="{{ $item->id }}" {{ old('kategori_bangunan_id') == $item->id ? 'selected' : '' }}>{{ $item->kode }} - {{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <select class="form-select select2" id="kondisi_bangunan_id" name="kondisi_bangunan_id" required>
                                    ...
                                    @foreach ($kondisi as $item)   
                                        <option value="{{ $item->id }}" {{ old('kondisi_bangunan_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <input type="text" class="form-control @error('tanggal_dokumen_bangunan')
                                    is-invalid
                                @enderror picker" name="tanggal_dokumen_bangunan" id="tanggal_sertifiat" value="{{ old('tanggal_dokumen_bangunan') }}" autocomplete="off"/>
