...
@section('title', 'Edit Inventaris Tanah')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" action="{{ route('site.inventarisTanah.update', $inventarisTanah) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-select select2" id="kategori_tanah_id" name="kategori_tanah_id" required>
                                    ...
                                    @foreach ($kategoriTanah as $item)   
                                        <option value="{{ $item->id }}" {{ old('kategori_tanah_id', $inventarisTanah->kategori_tanah_id) == $item->id ? 'selected' : '' }}>{{ $item->kode }} - {{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="nama"
                                    value="{{ old('nama',$inventarisTanah->nama) }}"
                                    placeholder="{{ $inventarisTanah->nama }}"
                                    />
                                    @error('nama')
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="kode"
                                    value="{{ old('kode',$inventarisTanah->kode) }}"
                                    placeholder="{{ $inventarisTanah->kode }}"
                                    />
                                    @error('kode')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="no_register"
                                    value="{{ old('no_register',$inventarisTanah->no_register) }}"
                                    placeholder="{{ $inventarisTanah->no_register }}"
                                    />
                                    @error('no_register')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        <input type="number" class="form-control @error('luas')
                                            is-invalid
                                        @enderror" name="luas"
                                        value="{{ old('luas',$inventarisTanah->luas) }}"/>
                                        @error('luas')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="tahun"
                                    value="{{ old('tahun',$inventarisTanah->tahun) }}"
                                    />
                                    @error('tahun')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <select class="form-select select2" id="hak_tanah_id" name="hak_tanah_id" required>
                                    ...
                                    @foreach ($hakTanah as $item)   
                                        <option value="{{ $item->id }}" {{ old('hak_tanah_id',$inventarisTanah->hak_tanah_id) == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                ...
                                <select class="form-select select2" id="penggunaan_id" name="penggunaan_id" required>
                                    ...
                                    @foreach ($penggunaan as $item)   
                                        <option value="{{ $item->id }}" {{ old('penggunaan_id',$inventarisTanah->penggunaan_id) == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                ...
                                <select class="form-select select2" id="pengguna_barang_id" name="pengguna_barang_id" required>
                                    ...
                                    @foreach ($penggunaBarang as $item)   
                                        <option value="{{ $item->id }}" {{ old('pengguna_barang_id',$inventarisTanah->pengguna_barang_id) == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            <div class="col-md-12 col-12">
                                ...
                                <select class="form-select select2" id="asal_id" name="asal_id" required>
                                    ...
                                    @foreach ($asal as $item)   
                                        <option value="{{ $item->id }}" {{ old('asal_id',$inventarisTanah->asal_id) == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" class="form-control @error('tanggal_sertifikat')
                                    is-invalid
                                @enderror picker" name="tanggal_sertifikat" id="tanggal_sertifiat" value="{{ old('tanggal_sertifikat',$inventarisTanah->tanggal_sertifikat) }}" autocomplete="off"/>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="no_sertifikat"
                                    value="{{ old('no_sertifikat',$inventarisTanah->no_sertifikat) }}"
                                    />
                                    @error('no_sertifikat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-8 col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        id="harga"
                                        name="harga"
                                        value="{{ old('harga',$inventarisTanah->harga) }}"
                                        />
                                        @error('harga')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                            ...
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control @error('alamat')
                                        is-invalid
                                    @enderror" id="alamat" name="alamat" rows="3">{{ old('alamat',$inventarisTanah->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control @error('keterangan')
                                        is-invalid
                                    @enderror" id="keterangan" name="keterangan" rows="3">{{ old('keterangan',$inventarisTanah->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
