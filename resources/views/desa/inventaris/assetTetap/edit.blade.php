...
@section('title', 'Edit Inventaris Asset Tetap')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" action="{{ route('site.inventarisAssetTetap.update', $inventarisAssetTetap) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-select select2" id="kategori_asset_id" name="kategori_asset_id" required>
                                    ...
                                    @foreach ($kategoriAssets as $item)   
                                        <option value="{{ $item->id }}" {{ old('kategori_asset_id',$inventarisAssetTetap->kategori_asset_id) == $item->id ? 'selected' : '' }}>{{ $item->kode }} - {{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    name="nama"
                                    value="{{ old('nama') }}"
                                    placeholder="{{ $inventarisAssetTetap->nama }}"
                                    />
                                    @error('nama')
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    name="kode"
                                    value="{{ old('kode') }}"
                                    placeholder="{{ $inventarisAssetTetap->kode }}"
                                    />
                                    @error('kode')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    placeholder="{{ $inventarisAssetTetap->no_register }}"
                                    />
                                    @error('no_register')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-select select2" id="jenis_asset_id" name="jenis_asset_id" required>
                                    ...
                                    @foreach ($jenisAssets as $item)   
                                        <option value="{{ $item->id }}" {{ old('jenis_asset_id',$inventarisAssetTetap->jenis_asset_id) == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="judul_buku"
                                    value="{{ old('judul_buku', $inventarisAssetTetap->judul_buku) }}"
                                    />
                                    @error('judul_buku')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    value="{{ old('spesifikasi_buku',$inventarisAssetTetap->spesifikasi_buku) }}"
                                    />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="asal_daerah"
                                    value="{{ old('asal_daerah',$inventarisAssetTetap->asal_daerah) }}"
                                    />
                                    @error('asal_daerah')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="pencipta"
                                    value="{{ old('pencipta',$inventarisAssetTetap->pencipta) }}"
                                    />
                                    @error('pencipta')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="jenis_hewan"
                                    value="{{ old('jenis_hewan',$inventarisAssetTetap->jenis_hewan) }}"
                                    />
                                    @error('jenis_hewan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="ukuran_hewan"
                                    value="{{ old('ukuran_hewan',$inventarisAssetTetap->ukuran_hewan) }}"
                                    />
                                    @error('ukuran_hewan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="jenis_tumbuhan"
                                    value="{{ old('jenis_tumbuhan',$inventarisAssetTetap->jenis_tumbuhan) }}"
                                    />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    value="{{ old('ukuran_tumbuhan',$inventarisAssetTetap->ukuran_tumbuhan) }}"
                                    />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    @enderror"
                                    name="tahun"
                                    value="{{ old('tahun',$inventarisAssetTetap->tahun) }}"
                                    />
                                    @error('tahun')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <select class="form-select select2" id="asal_id" name="asal_id" required>
                                    ...
                                    @foreach ($asal as $item)   
                                        <option value="{{ $item->id }}" {{ old('asal_id',$inventarisAssetTetap->asal_id) == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        id="jumlah"
                                        name="jumlah"
                                        value="{{ old('jumlah',$inventarisAssetTetap->jumlah) }}"
                                        />
                                        @error('jumlah')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        id="harga"
                                        name="harga"
                                        value="{{ old('harga',$inventarisAssetTetap->harga) }}"
                                        />
                                        @error('harga')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                            ...
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control @error('keterangan')
                                        is-invalid
                                    @enderror" id="keterangan" name="keterangan" rows="3">{{ old('keterangan',$inventarisAssetTetap->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
