...
@section('title', 'Inventaris Asset Tetap')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">List Inventaris Asset Tetap</h4>
          <a href="{{ route('site.inventarisAssetTetap.create') }}" class="btn btn-primary">@lang('Add')</a>
        </div>
        <div class="card-body mt-2">
          <a href="{{ route('site.form.laporan.cetak.inventaris', 'assetTetap') }}" class="btn btn-sm btn-primary">
  ...
  <script>
    ...
    $(function () {
        ...
        if (dt_ajax_table.length) {
            ...
            processing: true,
            ajax: '{{ route('site.inventarisAssetTetap.index') }}', // JSON file to add data
            columns: [
            ...
            columnDefs: [
              {
                ...
                render: function (data, type, full, meta) {
                  var id = full['id'];
                  return (
                    '<a href="/site/inventarisAssetTetap/' + full['id'] +'" class="item-edit me-1" title="detail">' +
                    feather.icons['eye'].toSvg({ class: 'font-small-4' }) +
                    '</a>'+
                    '<a href="/site/inventarisAssetTetap/' + full['id'] +'/edit" class="item-edit me-1" title="edit">' +
    ...
    function hapus(e){
      var url = '{{ route("site.inventarisAssetTetap.destroy", ":id") }}';
