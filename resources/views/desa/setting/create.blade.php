  ...
  <div class="col-12">
    ...
    <div class="card">
      ...
      <div class="card-body py-2 my-25">
        ...
        <!-- form -->
        <form class="validate-form mt-2 pt-50" action="{{ route('settings.store') }}" method="post" enctype="multipart/form-data">
            @csrf
          <div class="row">
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <input
                ...
                data-msg="Please enter app name"
              />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="app_phone">App Phone</label>
              <input
                type="text"
                class="form-control"
                id="app_phone"
                ...
                value="{{ settings()->get('app_phone'); }}"
                data-msg="Please enter app phone"
              />
            </div>
            <div class="col-12 col-sm-6 mb-1">
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <input
                ...
                value="{{ settings()->get('app_website'); }}"
