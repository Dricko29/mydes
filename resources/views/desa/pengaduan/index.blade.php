            ...
            columnDefs: [
              ...
              },
              {
                ...
                render: function (data, type, full, meta) {
                  var id = full['id'];
                  return (
                    '<a href="/site/pengaduan/' + full['id'] +'" class="item-edit me-1" title="detail">' +
                    feather.icons['eye'].toSvg({ class: 'font-small-4' }) +
                    '</a>'+
                    '<a href="/site/pengaduan/' + full['id'] +'/edit" class="item-edit me-1" title="edit">' +
