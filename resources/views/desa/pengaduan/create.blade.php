...
@section('title', __('Add').' Pengaduan')
  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header border-bottom">
        ...
        <a href="{{ route('pegawai.index') }}" class="btn btn-primary">@lang('Back')</a>
      </div>
      <div class="card-body py-2 my-25">
        <!-- form -->
        <form class="validate-form mt-2 pt-50" action="{{ route('pegawai.store') }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <!-- header section -->
