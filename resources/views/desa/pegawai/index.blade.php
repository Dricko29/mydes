    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          ...
          <a href="{{ route('site.pegawai.create') }}" class="btn btn-primary">@lang('Add')</a>
        </div>
  ...
  <script>
    ...
    $(function () {
        ...
        if (dt_ajax_table.length) {
            ...
            processing: true,
            ajax: '{{ route('site.pegawai.index') }}', // JSON file to add data
            columns: [
            ...
            columnDefs: [
              ...
              },
              {
                ...
                render: function (data, type, full, meta) {
                  var id = full['id'];
                  return (
                    '<a href="/site/pegawai/' + full['id'] +'" class="item-edit me-1" title="detail">' +
                    feather.icons['eye'].toSvg({ class: 'font-small-4' }) +
                    '</a>'+
                    '<a href="/site/pegawai/' + full['id'] +'/edit" class="item-edit me-1" title="edit">' +
    ...
    function hapus(e){
      var url = '{{ route("site.pegawai.destroy", ":id") }}';
