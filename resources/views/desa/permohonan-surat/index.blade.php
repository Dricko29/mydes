  ...
  <script>
    ...
    $(function () {
        ...
        if (dt_ajax_table.length) {
            ...
            processing: true,
            ajax: '{{ route('site.permohonanSurat.index') }}', // JSON file to add data
            columns: [
            ...
            columnDefs: [
              ...
              //     };
              //     return (
              //       '<a href="/site/surat/' + full['id'] +'/persyaratan" class="item-edit me-1" title="persyaratan">' +
              //       feather.icons['list'].toSvg({ class: 'font-small-4' }) +
              //       '</a>'+
              //       '<a href="/site/surat/' + full['id'] +'/edit" class="item-edit me-1" title="edit">' +
              //       feather.icons['edit'].toSvg({ class: 'font-small-4' }) +
              //       '</a>'+
              //       '<a href="/site/surat/' + full['id'] +'/status" class="item-edit me-1" title="'+info+'">' +
              //       icon +
              //       '</a>'+
          ...
          var id = [];
          {
              ...
              if(id.length > 0)
              {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url:'{{ route('site.permohonanSurat.bulkDelete') }}',
                            data:{id:id},
                            method:'post',
                            headers:{
    ...
    // single delete
    function hapus(e){
      var url = '{{ route("site.permohonanSurat.destroy", ":id") }}';
