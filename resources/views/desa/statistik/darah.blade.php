...
@section('title', 'Statistik Golongan Darah')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Statistik Golongan Darah Penduduk</h4>
      </div>
        <div class="card-body border-bottom">
          <div class="row">
            <div class="col-md-4">
                <a href="{{ route('site.statistik.form.cetak', 'darah') }}" class="btn btn-sm btn-primary">
        ...
        <table class="table table-bordered mb-0">
          <thead>
            <tr>
              ...
              <th scope="col" class="text-nowrap">Gol Darah</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $darah->sum('penduduk_count')}}</td>
              <td>{{ number_format(($darah->sum('penduduk_count')/$pendudukTotal)*100),2}}%</td>
              <td>{{ $darah->sum('laki')}}</td>
              <td>{{ number_format(($darah->sum('laki')/$pendudukTotal)*100),2}}%</td>
              <td>{{ $darah->sum('perempuan')}}</td>
              <td>{{ number_format(($darah->sum('perempuan')/$pendudukTotal)*100),2}}%</td>
            </tr>
          </tbody>
        </table>
      </div>
