        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Laporan Statistik {{ Str::ucFirst($jenis) }}</h4>
                    <a href="{{ url('site/statistik/'.$jenis.'') }}" class="btn btn-primary">@lang('Back')</a>
                </div>
                <div class="card-body">
                    <form class="form" action="{{ route('site.statistik.cetak.laporan') }}" target="blank" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
