...
@section('title', 'Statistik Hubungan Keluarga')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Statistik Hubungan Keluarga Penduduk</h4>
      </div>
        <div class="card-body border-bottom">
          <div class="row">
            <div class="col-md-4">
                <a href="{{ route('site.statistik.form.cetak', 'hubungan') }}" class="btn btn-sm btn-primary">
        ...
        <table class="table table-bordered mb-0">
          <thead>
            <tr>
              ...
              <th scope="col" class="text-nowrap">Nama Hubungan</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $hubungan->sum('penduduk_count')}}</td>
              <td>{{ number_format(($hubungan->sum('penduduk_count')/$pendudukTotal)*100),2}}%</td>
              <td>{{ $hubungan->sum('laki')}}</td>
              <td>{{ number_format(($hubungan->sum('laki')/$pendudukTotal)*100),2}}%</td>
              <td>{{ $hubungan->sum('perempuan')}}</td>
              <td>{{ number_format(($hubungan->sum('perempuan')/$pendudukTotal)*100),2}}%</td>
            </tr>
          </tbody>
        </table>
      </div>
