  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header border-bottom">
        ...
        <a href="{{ route('site.users.index') }}" class="btn btn-primary">@lang('Back')</a>
      </div>
      <div class="card-body mt-2">
        <!-- form -->
        <form class="validate-form0" action="{{ route('site.users.store') }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <select class="form-select select2" id="role" name="role_id">
