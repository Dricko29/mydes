    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          ...
          <a href="{{ route('site.users.create') }}" class="btn btn-sm btn-primary">Tambah</a>
        </div>
  ...
  <script>
    ...
    $(function () {
        ...
        if (dt_ajax_table.length) {
            ...
            processing: true,
            ajax: '{{ route('site.users.index') }}', // JSON file to add data
            columns: [
            ...
            columnDefs: [
              ...
              },
              {
                    ...
                    targets: 3,
                    render: function (data, type, full, meta) {
                    var $image = full['profile_photo_url'];
                    if ($image) {
                        // For Avatar image
                        var $output =
    ...
    // single delete
    function hapus(e){
      var url = '{{ route("site.users.destroy", ":id") }}';
