...
@section('title', __('Edit').' Syarat Surat')
  ...
  <div class="col-12">
    ...
    <div class="card">
      ...
      <div class="card-body py-2 my-25">
        <!-- form -->
        <form class="validate-form" action="{{ route('site.syaratSurat.update', $syaratSurat->id) }}" method="post" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-12 col-sm-12 mb-1">
              ...
              <input
                ...
                id="nama"
                name="nama"
                value="{{ old('nama',$syaratSurat->nama) }}"
              />
              @error('nama')
