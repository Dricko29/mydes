    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">List Syarat Surat</h4>
          <a href="{{ route('site.syaratSurat.create') }}" class="btn btn-primary">@lang('Add')</a>
        </div>
  ...
  <script>
    ...
    $(function () {
        ...
        if (dt_ajax_table.length) {
            ...
            processing: true,
            ajax: '{{ route('site.syaratSurat.index') }}', // JSON file to add data
            columns: [
            ...
            columnDefs: [
              ...
              },
              {
                ...
                render: function (data, type, full, meta) {
                  var id = full['id'];
                  return (
                    '<a href="/site/syaratSurat/' + full['id'] +'/edit" class="item-edit me-1" title="edit">' +
                ...
                buttons: [
                  {
                    ...
                    title: "Daftar Data Syarat Surat",
          ...
          var id = [];
          {
              ...
              if(id.length > 0)
              {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url:'{{ route('site.syaratSurat.bulkDelete') }}',
                            data:{id:id},
                            method:'post',
                            headers:{
    ...
    // single delete
    function hapus(e){
      var url = '{{ route("site.syaratSurat.destroy", ":id") }}';
