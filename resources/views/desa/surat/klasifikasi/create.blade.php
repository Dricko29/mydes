...
@section('title', __('Add').' Klasifikasi Surat')
  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header border-bottom">
        <h4 class="card-title">Klasifikasi Surat</h4>
        <a href="{{ route('site.klasifikasiSurat.index') }}" class="btn btn-primary">@lang('Back')</a>
      </div>
      <div class="card-body py-2 my-25">
        <!-- form -->
        <form class="validate-form" action="{{ route('site.klasifikasiSurat.store') }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
