    ...
    <div class="col-xl-12 col-md-12 col-12">
      <div class="card card-statistics">
        <div class="card-header">
          <h4 class="card-title">@lang('Statistik Artikel')</h4>
          ...
          <div class="row">
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">{{ $blogJml }}</h4>
                  <p class="card-text font-small-3 mb-0">Total Artikel</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">{{ $blogPublished }}</h4>
                  <p class="card-text font-small-3 mb-0">Artikel Published</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
              <div class="d-flex flex-row">
                <div class="avatar bg-light-success me-2">
                  <div class="avatar-content">
                    <i data-feather='arrow-left-circle' class="avatar-icon"></i>
                  </div>
                </div>
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">{{ $blogPending }}</h4>
                  <p class="card-text font-small-3 mb-0">Artikel Pending</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">{{ $blogDraft }}</h4>
                  <p class="card-text font-small-3 mb-0">Artikel Draft</p>
                </div>
              </div>
            </div>
          </div>
