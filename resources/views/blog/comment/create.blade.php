  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header border-bottom">
        ...
        <a href="{{ route('site.blog.categories.index') }}" class="btn btn-primary">@lang('Back')</a>
      </div>
      <div class="card-body py-2 my-25">
        <!-- form -->
        <form class="validate-form" action="{{ route('site.blog.categories.store') }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
  ...
  <script>
    $(function () {
      ...
      $('#nama').keyup(function(e) {
        $.get('{{ route('site.blog.cek.slug.category') }}',
          { 'nama': $(this).val() },
          function( data ) {
            $('#slug').val(data.slug);
          }
