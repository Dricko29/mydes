    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          ...
          <a href="{{ route('site.blog.tags.create') }}" class="btn btn-primary">@lang('Add')</a>
        </div>
  ...
  <script>
    ...
    $(function () {
        ...
        if (dt_ajax_table.length) {
            ...
            processing: true,
            ajax: '{{ route('site.blog.tags.index') }}', // JSON file to add data
            columns: [
            ...
            columnDefs: [
              ...
              },
              {
                ...
                render: function (data, type, full, meta) {
                  ...
                  return (
                    '<a href="/site/blog/tags/' + full['id'] +'/persyaratan" class="item-edit me-1" title="persyaratan">' +
                    feather.icons['list'].toSvg({ class: 'font-small-4' }) +
                    '</a>'+
                    '<a href="/site/blog/tags/' + full['id'] +'/edit" class="item-edit me-1" title="edit">' +
          ...
          var id = [];
          {
              ...
              if(id.length > 0)
              {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url:'{{ route('site.blog.tags.bulkDelete') }}',
                            data:{id:id},
                            method:'post',
                            headers:{
    ...
    // single delete
    function hapus(e){
      var url = '{{ route("site.blog.tags.destroy", ":id") }}';
