    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          ...
          <a href="{{ route('user.surat.ajukan') }}" class="btn btn-primary">@lang('Add')</a>
        </div>
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <select class="form-select select2" id="status" name="status">
                ...
                <option value="2">Menunggu Ditandatangani</option>
  ...
  <script>
    ...
    $(function () {
        ...
        if (dt_ajax_table.length) {
            ...
            processing: true,
            ajax: '{{ route('user.surat.user') }}', // JSON file to add data
            columns: [
