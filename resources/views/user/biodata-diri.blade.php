...
<div class="row" id="basic-table">
  <div class="col-12">
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('biodata.print') }}" target="blank" class="btn btn-info btn-sm" title="print biodata">
                ...
                <div class="row">
                    <div align="center">
                        <div class="mb-2">
                            ...
                            <img src="{{ asset(settings()->get('app_logo')) }}" alt="">
                        </div>
                        <h2 style="font-weight: 800">BIODATA PENDUDUK WARGANEGARA</h2>
                        <h5>Kec. {{ settings()->get('nama_kecamatan') }}, Kab. {{ settings()->get('nama_kabupaten') }}, Desa {{ settings()->get('nama_desa') }}</h5>
                    </div>
                  ...
                  <div class="card">
                    <div class="row mt-2">
                        ...
                        <div class="col-6 text-center">
                            ...
                            <h5>Kepala Desa {{ Str::ucfirst(settings()->get('nama_desa', 'goa boma')) }}</h5>
                            <br>
                            <br>
                            <br>
                            <br>
                            <br>
                            <h5 style="font-weight: 800">{{ Str::upper(settings()->get('kepala_desa')) }}</h5>
                        </div>
                    </div>
                  </div>
              </div>
