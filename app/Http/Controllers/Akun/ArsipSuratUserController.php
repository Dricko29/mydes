...
class ArsipSuratUserController extends Controller
{
    /**
    ...
    public function __invoke(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $model = LogSurat::with('penduduk', 'surat.klasifikasiSurat', 'pegawai', 'nomorSurat')->where('penduduk_id', $penduduk_id);
        ...
        return view('user.arsip-surat', compact('pageConfigs'));
    }
}