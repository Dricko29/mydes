...
class PrintKartuKeluargaPendudukController extends Controller
{
    /**
    ...
    public function __invoke(Request $request)
    {
        ...
        $keluargaLogin = Keluarga::where('id', $pendudukLogin->keluarga_id)->firstOrFail();

        abort_if(!auth()->user() == $pendudukLogin->user_id, 403);
        $pageConfigs = [
        ...
        return view('user.print-kk', compact(
            'pageConfigs',
            'keluarga',
            'penduduk'
        ));
