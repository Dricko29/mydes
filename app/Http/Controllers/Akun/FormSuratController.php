...
class FormSuratController extends Controller
{
    ...
    public function __invoke(Request $request, $id)
    {
        ...
        $surat = Surat::find($id);
        $layananMandiri = LayananMandiri::where('user_id', auth()->user()->id)->firstOrFail();
        return view('user.surat.form-surat-pengantar', compact('surat', 'layananMandiri', 'pageConfigs'));
    }
}