...
class UpdateInventarisAssetTetapRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'nama' => ['nullable'],
            'kode' => ['nullable', Rule::unique('inventaris_asset_tetaps')->ignore($this->inventarisAssetTetap)],
            'no_register' => ['nullable', Rule::unique('inventaris_asset_tetaps')->ignore($this->inventarisAssetTetap)],
